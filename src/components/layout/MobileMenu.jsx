  ...
  return (
    <div className="fixed inset-0 z-50 md:hidden">
      <div
        ...
        onClick={onClose}
      />
      <div className="absolute right-0 top-0 h-full w-64 bg-white shadow-xl p-6 animate-slide-in-right">
        <button
          onClick={onClose}
        ...
        <nav className="flex flex-col gap-4 mt-12">
          ...
          <button
            onClick={onClose}
            className="text-sapa-primary font-medium hover:text-sapa-accent transition-colors text-left"
          >
            Cek Status
          </button>

          <div className="border-t border-sapa-secondary/20 pt-4 mt-2">
            <p className="text-sapa-secondary text-sm font-medium mb-2">BEM APPS</p>
            <a
              href="#"
