...
export default function BentoGrid() {
  ...
  return (
    <section id="lapor" className="py-16 px-4">
      <motion.div
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-sapa-primary mb-4 tracking-tight">
            Pilih Kategori Laporan
          </h2>
          <p className="text-sapa-secondary max-w-lg mx-auto">
            Pilih kategori yang sesuai dengan aspirasi atau keluhan Anda
          </p>
        </motion.div>
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-sapa-accent/10 flex items-center justify-center mb-4 transition-colors group-hover:bg-sapa-accent/20">
                      <Icon className="w-6 h-6 text-sapa-accent" />
                    </div>
